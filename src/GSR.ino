...
class OverrideGSR : public WatchyGSR {
   ...
   * Be sure to visit
   * https://github.com/GuruSR/Watchy_GSR/blob/main/Override%20Information.md
   * for full information on how to override including functions that are
   * available to your override to enhance functionality.
   */
public:
  ...
  */
  ...
  /*
      bool InsertHandlePressed(uint8_t SwitchNumber, bool &Haptic, bool
     &Refresh) { switch (SwitchNumber){ case 2: //Back Haptic = true;  // Cause
     Hptic feedback if set to true. Refresh = true; // Cause the screen to be
     refreshed (redrwawn). return true;  // Respond with "I used a button", so
     the WatchyGSR knows you actually did something with a button. break; case
     3: //Up return true; break; case 4: //Down return true;
        }
        return false;
      };
  */
